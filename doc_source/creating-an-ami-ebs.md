...
Similarly, although you can create a Windows AMI from snapshot, it is unsupported to launch instances from such AMI and similar instances are subject to unforeseen circumstances\.  
